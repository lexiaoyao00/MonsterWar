...
void UIInteractive::addImage(entt::id_type name_id, engine::render::Image sprite)
{
...
void UIInteractive::render(engine::core::Context &context)
{
    ...
    // 先渲染自身
    context.getRenderer().drawUIImage(sprites_[current_sprite_id_], getScreenPosition(), size_);
