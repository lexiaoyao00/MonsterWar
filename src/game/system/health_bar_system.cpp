...
void HealthBarSystem::update(entt::registry &registery, engine::render::Renderer &renderer, engine::render::Camera &camera)
{
    auto view = registery.view<engine::component::TransformComponent,
        game::component::StatsComponent,
        game::defs::HasHealthBarTag,
        game::defs::InjuredTag>();  //受伤的才显示，满血不显示
